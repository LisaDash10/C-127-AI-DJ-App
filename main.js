...
function draw() {
    ...
    if(scoreRightWrist > 0.2) {
        ...
        if(rightWristY > 0 && rightWristY < 100) {
            ...
            document.getElementById("btn_speed").innerHTML = "Speed = 1.0x";
            song.rate(1);
        }
            ...
            document.getElementById("btn_speed").innerHTML = "Speed = 2.0x";
            song.rate(2);
        }
    ...
    if(scoreLeftWrist > 0.2) {
        ...
        document.getElementById("btn_volume").innerHTML = "Volume = " + volume;
